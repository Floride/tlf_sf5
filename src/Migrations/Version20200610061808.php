 ...
 */
final class Version20200610061808 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE c_accreditation (id INT AUTO_INCREMENT NOT NULL, level SMALLINT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', abbreviation VARCHAR(10) NOT NULL, category SMALLINT DEFAULT 0 NOT NULL, description LONGTEXT NOT NULL, is_default TINYINT(1) DEFAULT \'0\' NOT NULL, is_playable TINYINT(1) DEFAULT \'0\' NOT NULL, type SMALLINT DEFAULT 0 NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C182C54CBCF3411D (abbreviation), UNIQUE INDEX UNIQ_C182C54C5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE c_rank (id INT AUTO_INCREMENT NOT NULL, lvl_accred_min INT NOT NULL, picture VARCHAR(255) DEFAULT NULL, score INT DEFAULT 0 NOT NULL, score_ol INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', abbreviation VARCHAR(10) NOT NULL, category SMALLINT DEFAULT 0 NOT NULL, description LONGTEXT NOT NULL, is_default TINYINT(1) DEFAULT \'0\' NOT NULL, is_obsolete TINYINT(1) DEFAULT \'0\' NOT NULL, is_playable TINYINT(1) DEFAULT \'0\' NOT NULL, type SMALLINT DEFAULT 0 NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2CDCB3B4BCF3411D (abbreviation), UNIQUE INDEX UNIQ_2CDCB3B45E237E06 (name), INDEX IDX_2CDCB3B42C1BECD6 (lvl_accred_min), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE c_role (id INT AUTO_INCREMENT NOT NULL, lvl_accred_min INT NOT NULL, rank_min_id INT DEFAULT NULL, rank_max_id INT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', abbreviation VARCHAR(10) NOT NULL, category SMALLINT DEFAULT 0 NOT NULL, description LONGTEXT NOT NULL, is_default TINYINT(1) DEFAULT \'0\' NOT NULL, is_obsolete TINYINT(1) DEFAULT \'0\' NOT NULL, is_playable TINYINT(1) DEFAULT \'0\' NOT NULL, type SMALLINT DEFAULT 0 NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F3CCD13BBCF3411D (abbreviation), UNIQUE INDEX UNIQ_F3CCD13B5E237E06 (name), INDEX IDX_F3CCD13B2C1BECD6 (lvl_accred_min), INDEX IDX_F3CCD13B5DE0DFBF (rank_min_id), INDEX IDX_F3CCD13B18E29C3D (rank_max_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE c_rank ADD CONSTRAINT FK_2CDCB3B42C1BECD6 FOREIGN KEY (lvl_accred_min) REFERENCES c_accreditation (id)');
        $this->addSql('ALTER TABLE c_role ADD CONSTRAINT FK_F3CCD13B2C1BECD6 FOREIGN KEY (lvl_accred_min) REFERENCES c_accreditation (id)');
