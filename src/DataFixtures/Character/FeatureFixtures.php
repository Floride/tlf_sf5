    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach ($listFeatures as $element) {
            $feature = (new Feature()) // On crée une caractéristique
                ...
                ->setAbbreviation($element['abbr']) // On ajoute l'abréviation
