...
Une valeur de Constitution élévée signfie que le personnage est bien alimenté, solide comme un roc, possède des os résistants et un système immunitaire fiable. Une valeur de Constitution élévée n\'est pas une garantie de taille élevée mais s\'est souvent le cas.'
            ],
            [
                'nom' => 'Force', 'abrev' => 'FOR',
                'valeurMin' => 20, 'valeurMax' => 100, 'valeurMoy' => 40, 'type' => 1,
...
Un personnage geignard, une attitude de "moi je" ou une incapacité à lire le langage non-verbal ou saisir certaines subtilités sont des exemplesde ce qui peut traduire une valeur de Charisme vraisemblablemnt basse.
...
C\'est la caractéristique principale des personnages "qui assurent", imposent "naturellement" le respect et ont un côté "sexy" qui ne s\'explique pas.'
            ...
            [
                ...
                'valeurMin' => 20, 'valeurMax' => 100, 'valeurMoy' => 40, 'type' => 2,
                'description' => 'Cette caractéristique représente la capacité intellectuelle et de mémorisation du personnage. Elle donne une valeur à la capacité et la vitesse d\'apprentissage, sa capacité à se souvenir de détails ou exécuter des tâches de mémoire.'
            ],
            [
                'nom' => 'Volonté', 'abrev' => 'VOL',
                'valeurMin' => 20, 'valeurMax' => 100, 'valeurMoy' => 40, 'type' => 2,
                'description' => 'Cette caractéristique est un indicateur de la capacité du personnage à continuer alors qu\'il voudrait abandonné. Un personnage avec une faible volonté se repose sur les autres lorsque un décision importante doit être prise. A l\'opposé, un personnage avec un forte valeur en volonté aura de l\'assurance et tendance à ne pas à ne jamais abandonner ni désespérer. C\'est aussi la capacité qui permet au personnage de résister à la manipulation, par exemple.'
            ],
            [
